...
continue_btn.onclick = () => {
  ...
  const myTimeout = setTimeout(startteste, 3000);

  function startteste() {    
    loader.classList.add("hidden");
    start_btn_home.classList.remove("hidden");
    teste_box.classList.add("activeteste"); 
    showQuetions(0); 
    queCounter(1); 
    startTimer(15); 
    startTimerLine(0);
...
const restart_teste = result_box.querySelector(".buttons .restart");
const quit_teste = result_box.querySelector(".buttons .quit");
...
function optionSelected(answer) {
  ...
  if (userAns == correcAns) {
    ...
    answer.insertAdjacentHTML("beforeend", tickIconTag); n
